      ...
      <div className="wrapper">
              ...
              >
                <MDBNavbarNav right>
                  ...
                  <MDBNavItem className="links">
                    <MDBNavLink
                      to="/pastEvents"
                      onClick={() => (window.location.href = "pastEvents")}
                    >
                      Past Events
                    </MDBNavLink>
                  </MDBNavItem>
                  <MDBNavItem className="links">
                    <MDBNavLink
                      to="/"
                      onClick={() => this.scrollTo(this.refs.carousel)}
                    >
                      Events
                    </MDBNavLink>
                  </MDBNavItem>
                  <MDBNavItem className="links">
                    <MDBNavLink
                      to="/"
                      onClick={() => this.scrollTo(this.refs.about)}
                    >
                      About
                    </MDBNavLink>
                  </MDBNavItem>
                  <MDBNavItem className="links">
                    <MDBNavLink
                      to="/"
                      onClick={() => this.scrollTo(this.refs.calendar)}
                    >
                      Calendar
                    </MDBNavLink>
                  </MDBNavItem>
                  <MDBNavItem className="links">
                    <MDBNavLink
                      to="/"
                      onClick={() => this.scrollTo(this.refs.footer)}
                    >
                      Contact
                    </MDBNavLink>
                  </MDBNavItem>
                  <MDBNavItem>
                    <MDBNavLink
                      to="/"
                      onClick={() => this.scrollTo(this.refs.subscribe)}
                    >
        ...
        <div className="content" ref="hook">
          <MDBJumbotron className="hook">
            <div className="hook-left">
              <p className="h5-responsive">
                Creating impact and <strong>empowering</strong>
              </p>
              <p className="h5-responsive">
                <strong>students</strong> through technology.
              </p>
          ...
          <div className="section-about" ref="about">
            ...
            <p>
              The developer student clubs at the University of Toronto seek to
              provide students on the Saint George, Missisauga, and Scarborough
              campuses with opportunities to understand, work with the latest
              and greatest in technology. We focus on promoting student
              innovation, enabling collaboration between students and their
              local communitiesto="/", and empowering students to overcome fears
              and misconceptions towards how difficult it is to get started with
              tech.
            </p>
          </div>
          ...
          <div className="section-calendar" ref="calendar">
            <h2 className="h6-responsive">
              <b>Calendar</b>
            </h2>
            <MDBIframe
              src={process.env.REACT_APP_google_cal}
              frameborder="0"
              scrolling="no"
            />
          </div>
